...
function ENT:Draw()
    ...
    cam.Start3D2D(pos + self:GetForward() * (self:OBBMaxs().y - 4), ang, 0.11)
        ...
        draw.SimpleTextOutlined(self:GetWeed() .. " ounces", "weed_box", 0, -10, self:GetWeed() == 0 and color_red or color_darkgreen, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP, 1, color_black)
    cam.End3D2D()
end